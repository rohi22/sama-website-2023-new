 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Edit Industry</h4>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-body">
                    <form action="{{url('/industry/edit/'.$data->id)}}" method="post">
                        {{csrf_field()}}
                        <div class="form-body">
                            <div class="row">
                                <!-- row -->
                                <div class="col-md-8">
                                    <div class="form-group @if($errors->has('s_title')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="title" value="{{ $data->title }}">
                                    ...
                                    <div class="form-group @if($errors->has('url')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger"  name="url" value="{{ $data->url }}">
                                            <small class="form-control-feedback">@if($errors->has('url')) {{ $errors->first('url') }} @endif</small> 
                                        </div>
                                    </div>
