 ...
 <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Add Tag</h4>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-body">
                    <form action="{{asset('tag/new')}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
                        <div class="form-body">
                            <div class="row">
                                <!-- row -->
                                <div class="col-md-8">
                                    <div class="form-group @if($errors->has('gt_title')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="gt_title" value="{{old('gt_title')}}">
                                    ...
                                    <div class="form-group @if($errors->has('gt_slug')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="gt_slug" value="{{old('gt_slug')}}">
                                    ...
                                    <div class="form-group @if($errors->has('gt_meta_title')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="gt_meta_title" value="{{old('gt_meta_title')}}">
                                    ...
                                    <div class="form-group @if($errors->has('gt_meta_key_words')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="hidden" name="gt_meta_key_words" id="tags">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group @if($errors->has('gt_desc')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control form-control-danger"  id="gt_desc" name="gt_desc" value="{{old('gt_desc')}}">{{old('gt_desc')}}</textarea>
                                    ...
                                    <div class="form-group @if($errors->has('gt_meta_desc')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control form-control-danger"  id="gt_meta_desc" name="gt_meta_desc" value="{{old('gt_meta_desc')}}">{{old('gt_meta_desc')}}</textarea>
                                    ...
                                    <div class="form-group @if($errors->has('gt_meta_descr')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control form-control-danger"  id="gt_meta_descr" name="gt_meta_descr" value="{{old('gt_meta_descr')}}">{{old('gt_meta_descr')}}</textarea>
