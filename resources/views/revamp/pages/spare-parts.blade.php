...
@section('main')
    <meta name="description"
        content="Spare Parts are the different individual pieces that are combined together to form a whole structure in the form of machines such as spare parts of the Snack Packing Machine." />
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 devider position-relative py-lg-5 py-sm-4 pt-4 pb-2">
                    <div class="row">
                        <div class="col-lg-9 col-sm-12">
                            <img src="https://www.samaengineering.com/uploads/about/6014133e5768bWhatsApp Image 2021-01-29 at 6.50.32 PM.jpeg"
                                class="img-thumbnail mb-lg-5 mb-3" alt="...">
                            <p class="mb-4">We are the leading manufacturers and suppliers of Packaging Machine Spare
                                Parts and Processing Systems. We are the only organization who works on Sales, Services &
                                Spare Parts availability (3S) from more than 35 years.</p>
                            <p class="mb-4">We keep numerous range of all packaging machines and processing systems, spare
                                parts which meets the high quality standards. We deliver as we promise in multiple varieties
                                & specialist spare parts.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 bgSR position-relative py-lg-5 py-sm-4 pt-2 pb-4">
                    ...
                    <form method="post" class="from position-relative w-100 mt-4"
                        action="{{ url('/spare-parts/submit') }}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="company"
                                            placeholder="Company / Organization" name="company"
                                            value="{{ old('company') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="comaddressany"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="machine_modal"
                                            placeholder="Machine Modal" name="model" value="{{ old('model') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="any_detail"
                                            placeholder="Any Detail" name="any_detail" value="{{ old('any_detail') }}">
                                        <label for="any_detail">Any Detail</label>
                                        <p style="color:red;">
                                            @if ($errors->has('any_detail'))
                                                {{ $errors->first('any_detail') }}
                                            @endif
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="input-group mb-2">
                                <div class="g-recaptcha" data-sitekey="{{ config('services.recaptcha.sitekey') }}"
                                    style="width: desired_width;border-radius: 4px;overflow: hidden;"></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="submit" class="btn rounded-0 btn-danger py-2 px-5 mt-3">Send
                                        Now</button>
                                </div>
                            </div>
                        </div>
