      ...
      <div class="MainSlider owl-carousel">
         <div class="Items fa-4x text-center fw-bolder text-white">
            <div class="row slider-content-row">
               <img src="https://www.samaengineering.com/uploads/sliders/banner-top-second.jpeg">
               <!--    <div class="content-box" >-->
               <!--    <div class="col-lg-6 col-sm-12 text-style">-->
               <!--        <h2>Heading 2</h2>-->
               <!--        <h2 class="heading">Heading Frist</h2>-->
               <!--        <ul class="sam-ul">-->
               <!--            <li><i class="fa-solid fa-circle-radiation fa-spin"></i>Heading Thrid</li>-->
               <!--            <li><i class="fa-solid fa-circle-radiation fa-spin"></i>Heading Fourth</li>-->
               <!--            <li><i class="fa-solid fa-circle-radiation fa-spin"></i>Heading Fifth</li>-->
               <!--            <li><i class="fa-solid fa-circle-radiation fa-spin"></i>Heading Sixth</li>-->
               <!--            <li><i class="fa-solid fa-circle-radiation fa-spin"></i>Heading Seventh</li>-->
               <!--        </ul>-->
               <!--    </div>-->
