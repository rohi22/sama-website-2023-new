                  ...
                  <form method="get" action="{{route('revamp.search')}}">
                    ...
                    <button type="submit" class="fa fa-search search-btn sb customwork"
                      style="position: absolute; top: 15px; right: 163px; border-inline-end-style: none; 
                        border-bottom-style: none; margin-top: -11px; border-color: #ec2424;padding:6px;margin-right:0px; height: 29px; border-radius: 8px;" value="Search"
        ...
        <nav class="pushy pushy-left  sama-nav-mob" data-focus="#first-link">
          ...
          <div class="pushy-content">
            ...
            <ul class="sama-ul">
              ...
              @php
                  $subcategories = DB::table('categories')->where('parent_id','=',$parent->id)->where('status',
                  1)->orderBy('cat_order','ASC')->get(['categories.*']);
                @endphp
