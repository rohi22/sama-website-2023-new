...
footer .btn-scroll-top i {
  ...
  @media screen and (max-width:980px){
   ...
   footer .sama-quick, footer .sama-policy {
    display: none;
}
...
.sama-footer p, .sama-footer span{
    text-align: left;
}
...
button.top-btn:before {
  ...
  <footer class="bgSR bgMap position-relative text-center text-lg-start sama-footer">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="w-100 d-flex mb-3 sama-information">
                  ...
                  <span> <a href="https://goo.gl/maps/CUYX7Km5RiMwbDAX7" target="_blank">{!! $footer_content->f_address !!}</a></span>
                </div>  
                <div class="w-100 d-flex mb-3  sama-information align-items-center">
                  <span class="iconBox d-flex justify-content-center align-items-center text-white bg-TColor">
                    <i class="far fa-envelope"></i>
                  </span>
                  <span><a href="mailto:{{$footer_content->f_email_1}}">{{$footer_content->f_email_1}}</a></span>
                </div>
                <!--<div class="w-100 d-flex mb-3 sama-information align-items-center">-->
                <!--  <span class="iconBox d-flex justify-content-center align-items-center text-white bg-TColor">-->
      ...
      <div class="Flyoutbtn Flyoutbtn3">
        ...
        <span class="bg-success"><a href="https://wa.me/{{str_replace('+','',$footer_content->f_phone_4)}}" class="text-white">{{$footer_content->f_phone_4}}</a></span>
      </div> 
