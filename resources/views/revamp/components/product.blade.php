<div class="card PrCard rounded-0">              
              <a href="{{asset('revamp/product/'.$item->p_slug)}}" class="d-flex w-100 flex-column" >                
                <div class="imGBox w-100 pt-3" style="background-image:url('{{asset('uploads/product/'.$item->p_main_image)}}'); background-size: cover;object-fit: contain;  background-position: center;">
