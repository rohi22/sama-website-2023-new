 ...
 <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card ">
                <div class="card-body">
                    <form action="{{asset('admin/user/edit/'.$data->id)}}" method="post" enctype="multipart/form-data">{{csrf_field()}}
                        <div class="form-body">
                            <div class="row">
                                <!-- row -->
                                <div class="col-md-8">
                                    <div class="form-group @if($errors->has('name')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="name" value="{{$data->name}}">
                                    ...
                                    <div class="form-group @if($errors->has('contact')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="contact" value="{{$data->contact}}">
                                    ...
                                    <div class="form-group @if($errors->has('email')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger" name="email" value="{{$data->email}}">
                                    ...
                                    <div class="form-group @if($errors->has('password')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control form-control-danger"  name="password" value="{{$data->password}}">
                                    ...
                                    <div class="form-group @if($errors->has('role')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control form-control-danger"  name="role">
                                                ...
                                                <option value="1" @if($data->role == 1) selected @endif >Sama Data Entry User</option>
                                                <option value="2" @if($data->role == 2) selected @endif >Blog User</option>
                                            </select>
                                    ...
                                    <div class="form-group @if($errors->has('bio_desc')) has-danger @endif row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control form-control-danger"  id="bio_desc" name="bio_desc" value="{{$data->bio_desc}}">{{$data->bio_desc}}</textarea>
